...
public class WuKongSounds {
    ...
    public static RegistryObject<SoundEvent> AN_SHEN = registerSoundEvent("an_shen");
    public static RegistryObject<SoundEvent> FEN_SHEN = registerSoundEvent("fen_shen");
